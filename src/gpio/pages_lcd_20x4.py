...
WIDGETS = {
	...
	'title': { 'type':'text', 'format':'{0}', 'variables':['title'], 'font':'small', 'just':'centerchar', 'size':(100,8) },
	# 'artist': { 'type':'text', 'format':'{0}', 'variables':['artist'], 'font':'small','varwidth':True,'effect':('scroll','left',5,1,20,'onloop',3,100)},
	'artist':  { 'type':'text', 'format':'{0}', 'variables':['artist'], 'font':'small', 'just':'centerchar', 'size':(100,8), 'varwidth':True},
	'station': { 'type':'text', 'format':'{0}', 'variables':['artist'], 'font':'small', 'just':'centerchar', 'size':(100,8), 'varwidth':True},
	# 'album': { 'type':'text', 'format':'{0}', 'variables':['album'], 'font':'small','varwidth':True,'effect':('scroll','left',5,1,20,'onloop',3,100)},
	'album': { 'type':'text', 'format':'{0}', 'variables':['album'], 'font':'small', 'just':'centerchar', 'size':(100,8) },
	...
	'volume': { 'type':'text', 'format':'VOL {0}', 'variables':['volume'], 'font':'small', 'varwidth':True, 'just':'left', 'size':(95,8)},
	...
	'songprogress': { 'type':'progressbar', 'value':'elapsed', 'rangeval':(0,'length'), 'size':(60,8) },
...
CANVASES = {
	# 'play_artist': { 'widgets': [ ('artist',0,8), ('nowplaying',0,0), ('nowplayingdata',60,0), ('playstopsymbol', 50,16), ('songprogresstext',0,24), ('songprogress',20,24), ('trkprogresstext',60,24), ('trkprogress',75,24) ], 'size':(100,32) },
	'play_album': { 'widgets': [ ('title',0,0), 
								 ('artist',0,8), 
	                             ('album',0,16), 
	                             ('playstopsymbol', 0,24), ('songprogress',10,24), ('nowplayingdata',70,24) ], 
								 'size':(100,32) },
	# 'play_title': { 'widgets':  [ ('title',0,8), ('nowplaying',0,0), ('nowplayingdata',60,0), ('playstopsymbol', 50,16), ('songprogresstext',0,24), ('songprogress',20,24), ('trkprogresstext',60,24), ('trkprogress',75,24) ], 'size':(100,32) },
	# 'play_radio': { 'widgets': [ ('artistradio',0,0), ('title',0,8), ('radio',35,24), ('elapsed',0,24), ('timesmall',60,24)  ], 'size':(100,32) },
	'play_radio': { 'widgets': [ ('station',0,0), ('title',0,8), ('radio',35,24), ('volume',0,24), ('timesmall',60,24)  ], 'size':(100,32) },
...
SEQUENCES = [
	{	'name': 'seqSplash', 'canvases': [ { 'name':'splash', 'duration':4 } ], 'conditional':"db['state']=='starting'"   },
	{
		'name': 'seqPlay',
		'canvases': [
			{ 'name':'play_album', 'duration':8, 'conditional':"not db['encoding']=='webradio'" },
			# { 'name':'play_radio', 'duration':8, 'conditional':"not db['stream']=='webradio'" },
			# { 'name':'play_album', 'duration':8, 'conditional':"db['stream']=='webradio'" },
			{ 'name':'play_radio', 'duration':9999, 'conditional':"db['encoding']=='webradio'" }
		],
